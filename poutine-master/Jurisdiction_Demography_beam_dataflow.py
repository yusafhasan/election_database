...
class Formatjname(beam.DoFn):
  def process(self, element):
    ...
    net_unemployment_change_16_18 = None
    if unemployed_count_16 != None and unemployed_count_18 != None:
        net_unemployment_change_16_18 = unemployed_count_16 - unemployed_count_18
    population_change_16_18 = None
    if pop_16 != None and pop_18 != None:
    ...
    pov_adult_count_18 = None
    if pov_count_18 != None and pov_minor_count_18 != None:
...
def run():         
    ...
    google_cloud_options.job_name = 'poutine-k'
    ...
    table_id = 'Jurisdiction_Demography_Beam_DF'
